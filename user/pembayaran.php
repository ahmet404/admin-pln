...
<form action="" method="POST">
	...
	<table class="tb-create">
		...
		<tr>
			<td>
				...
				<a href="home.php?hal=tagihan">Kembali</a>
			</td>
		</tr>
	</table>
	</form>
	...
	if($sql && $tag){
		echo "<script>alert('Pembayaran berhasil!');window.location.href='../admin/cetak_struk.php?id=$id';</script>";
	} else{
		echo "<script>alert('Pembayaran Gagal!');document.location.href='home.php?hal=tagihan';</script>";
	}
}
?>	